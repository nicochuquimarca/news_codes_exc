...
# 3. Query the authors with duplicated PersonIds in aarc and to later perform the OpenAlex duplicates excercise
# 4. Doi-author_name match second exercise (handle the PersonId duplicates)
# 5. (Not relevant for now) Merge Institution Dictionary and BusinessEconFaculty to get the OpenAlexId for the workplace and degree institution of the author
